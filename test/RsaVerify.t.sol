...
contract RsaVerifyTest is Test {
    ...
    */
    ...
    // The below tests yielded gas usage of 59966 and 106217, respectively.

    /**
     * Contents of private key (private.pem):
        -----BEGIN PRIVATE KEY-----
        
        -----END PRIVATE KEY-----
     */
    function test_local_1024_modulus_65537_e() public {
        bytes memory N = hex"";
     ...
     * Contents of private key (private.pem):
        -----BEGIN PRIVATE KEY-----
        
        RNBHDhnIXzRjJrdroPi1k3sf
        -----END PRIVATE KEY-----
     */
    function test_local_2048_modulus_65537_e() public {
